...
public class ClawMachineGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ClawMachineGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PondersRoleplayModModMenus.CLAW_MACHINE_GUI.get(), id);
