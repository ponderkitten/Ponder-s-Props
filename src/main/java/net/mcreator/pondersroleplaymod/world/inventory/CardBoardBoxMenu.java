...
public class CardBoardBoxMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public CardBoardBoxMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(PondersRoleplayModModMenus.CARD_BOARD_BOX.get(), id);
