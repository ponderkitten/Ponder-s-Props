...
public class MetalFoldedUpChairStackTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public MetalFoldedUpChairStackTileEntity(BlockPos pos, BlockState state) {
		super(PondersRoleplayModModBlockEntities.METAL_FOLDED_UP_CHAIR_STACK.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<MetalFoldedUpChairStackTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<MetalFoldedUpChairStackTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("metal_folded_up_chair_stack");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Metal Fold Up Chair Stack");
	}
