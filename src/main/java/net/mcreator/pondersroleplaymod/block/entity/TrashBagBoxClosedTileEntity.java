...
public class TrashBagBoxClosedTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public TrashBagBoxClosedTileEntity(BlockPos pos, BlockState state) {
		super(PondersRoleplayModModBlockEntities.TRASH_BAG_BOX_CLOSED.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<TrashBagBoxClosedTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<TrashBagBoxClosedTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("trash_bag_box_closed");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Trash Bag Box Closed");
	}
