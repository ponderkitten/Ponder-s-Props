...
public class PopcornmachineDrawerTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public PopcornmachineDrawerTileEntity(BlockPos pos, BlockState state) {
		super(PondersRoleplayModModBlockEntities.POPCORNMACHINE_DRAWER.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<PopcornmachineDrawerTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<PopcornmachineDrawerTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("popcornmachine_drawer");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Popcorn Machine Drawer");
	}
