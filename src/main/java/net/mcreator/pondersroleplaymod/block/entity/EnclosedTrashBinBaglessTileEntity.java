package net.mcreator.pondersroleplaymod.block.entity;
...
public class EnclosedTrashBinBaglessTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(36, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public EnclosedTrashBinBaglessTileEntity(BlockPos pos, BlockState state) {
		super(PondersRoleplayModModBlockEntities.ENCLOSED_TRASH_BIN_BAGLESS.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<EnclosedTrashBinBaglessTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<EnclosedTrashBinBaglessTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("enclosed_trash_bin_bagless");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new CardBoardBoxMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}

	@Override
	public Component getDisplayName() {
		return Component.literal("Enclosed Trash Bin");
	}
