...
public class FoldUpTableCenteredTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public FoldUpTableCenteredTileEntity(BlockPos pos, BlockState state) {
		super(PondersRoleplayModModBlockEntities.FOLD_UP_TABLE_CENTERED.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<FoldUpTableCenteredTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<FoldUpTableCenteredTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("fold_up_table_centered");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Fold Up Table");
	}
