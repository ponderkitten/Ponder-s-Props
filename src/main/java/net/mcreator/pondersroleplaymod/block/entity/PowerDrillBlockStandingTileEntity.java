...
public class PowerDrillBlockStandingTileEntity extends RandomizableContainerBlockEntity implements IAnimatable, WorldlyContainer {
	public AnimationFactory factory = GeckoLibUtil.createFactory(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public PowerDrillBlockStandingTileEntity(BlockPos pos, BlockState state) {
		super(PondersRoleplayModModBlockEntities.POWER_DRILL_BLOCK_STANDING.get(), pos, state);
	}
	...
	public void registerControllers(AnimationData data) {
		data.addAnimationController(new AnimationController<PowerDrillBlockStandingTileEntity>(this, "controller", 0, this::predicate));
		data.addAnimationController(new AnimationController<PowerDrillBlockStandingTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("power_drill_block_standing");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Power Drill");
	}
