...
public class DrainDisplayModel extends AnimatedGeoModel<DrainDisplayItem> {
	@Override
	public ResourceLocation getAnimationResource(DrainDisplayItem animatable) {
		return new ResourceLocation("ponders_roleplay_mod", "animations/drain.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(DrainDisplayItem animatable) {
		return new ResourceLocation("ponders_roleplay_mod", "geo/drain.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(DrainDisplayItem entity) {
