...
package net.mcreator.pondersroleplaymod.entity;
...
import net.mcreator.pondersroleplaymod.procedures.SeatOnEntityTickUpdateProcedure;
...
public class SeatEntity extends PathfinderMob {
	public SeatEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(PondersRoleplayModModEntities.SEAT.get(), world);
	}
