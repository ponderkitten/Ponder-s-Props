...
import net.mcreator.pondersroleplaymod.procedures.PlateItemrightclickedonblockProcedure;
...
public class PlateItem extends Item {
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		PlateItemrightclickedonblockProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.getPlayer());
