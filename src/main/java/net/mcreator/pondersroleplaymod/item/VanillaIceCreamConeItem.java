...
public class VanillaIceCreamConeItem extends Item {
	public VanillaIceCreamConeItem() {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		ItemStack retval = new ItemStack(PondersRoleplayModModItems.ICE_CREAM_CONE.get());
