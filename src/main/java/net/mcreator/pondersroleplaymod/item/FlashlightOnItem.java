...
import net.mcreator.pondersroleplaymod.procedures.FlashlightOnrightclickProcedure;
...
public class FlashlightOnItem extends Item {
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		FlashlightOnrightclickProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.getPlayer());
